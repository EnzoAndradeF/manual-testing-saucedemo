# **Relatório Final de Execução de Testes - Saucedemo**
...
| ------- | ------------------------------------------------------------------------------ | ---------- | ------ |
| BUG-001 | Checkout com o carrinho vazio                                                  | Alta       | Aberto |
| BUG-002 | Quantidade do produto não pode ser alterada                                    | Baixa      | Aberto |
| BUG-003 | Checkout com informações inválidas                                             | Alta       | Aberto |
